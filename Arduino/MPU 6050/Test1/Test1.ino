...
void retrieve_data(){
  ...
  //Signs based on rotation as seen in specific perspectives
  gyro_x = -gyro_x;   // Lateral view, front part on the left and back part on the right / Left part facing you and right part facing other side
